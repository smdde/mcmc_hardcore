...
Claude (Anthropic, claude-sonnet-4-6) 和 GPT-5.5 (OpenAI) 被用作本研究的计算和分析工具：用于生成和调试 Python 代码、交叉验证推导、识别相关文献以及辅助手稿准备。所有数值结果均由作者在个人工作站上独立运行代码验证。所有数学声明和结论均经过作者审查和批准。
